...
<main class="ha-shell">
	<section class="section-block">
		<div class="section-heading">
			<div>
				<div class="section-label"><?php esc_html_e( 'Channel', 'humanangle-issues' ); ?></div>
				<h1 class="section-title"><?php the_archive_title(); ?></h1>
				<?php the_archive_description( '<p class="archive-excerpt">', '</p>' ); ?>
			</div>
		</div>
		<?php if ( have_posts() ) : ?>
				...
				while ( have_posts() ) :
					...
					<article <?php post_class( 'archive-card' ); ?>>
						...
						<div class="archive-card-body">
							...
							<p class="archive-excerpt"><?php echo esc_html( wp_trim_words( get_the_excerpt(), 22 ) ); ?></p>
		...
		<?php else : ?>
			<div class="no-results">
				<p><?php esc_html_e( 'This archive does not have any stories yet.', 'humanangle-issues' ); ?></p>
			</div>
		<?php endif; ?>
	</section>
</main>
